...
\newcommand{\studycourse}{Information Systems}

\newcommand{\authorname}{Andre Weinkötz}
\newcommand{\city}{Munich}

\newcommand{\thesistype}{Master's Thesis}
\newcommand{\worktype}{\thesistype\space in Information Systems}
...
\include{titelpage/titlepage}
\include{titelpage/titlepage_inside}
...
\include{content/3_RequirementsElicitation}
\include{content/5_SystemDesign}
\include{content/6_ObjectDesign}
\include{content/7_CaseStudyEvaluation}
...
\include{appendix/appendixExample}
